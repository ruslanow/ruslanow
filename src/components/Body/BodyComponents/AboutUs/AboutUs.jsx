...
const c = styles.box + ' ' + styles.gridBox;
        ...
        <div className={styles.about}>
            ...
            <div className={styles.grid}>
                ...
                <div className={styles.box}>
                    ...
                    <p id="about__us__text">Мы выступаем в качестве помошника в чистоте сделки между заемщиком и кредитором, без
                        участия банков.</p>
                    <img src={logo2} alt="Иконка" />
                </div>
                <div className={styles.box}>
                    <h3 className="about__us__title">Основаная цель данного ресурса</h3>
                    <p id="about__us__text">Это объединение на одной площадке кредиторов и заемщиков для поиска оптимальных
                ...
                <div className={c}>
                    ...
                    <ul>
                        ...
                        <li><span>не трубются финансовые подтверждения о Ваших доходах и деятельности</span></li>
                        <li><span>проценты и сумму основного долга можно выплачивать по истечению срока кредита</span></li>
                    </ul>
                    <p id='star__pic'><img src={logo4} alt="Иконка" /></p>
                </div>
            </div>
        </div>
    );
