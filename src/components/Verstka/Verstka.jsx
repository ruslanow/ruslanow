...
let SomePage = (props) => {
    ...
    let FriendsList = props.state.usersData.map(p => <Friends name={p.name} id={p.id}/>)
                ...
                <div className={styles.body}>
                    ...
                    <div className={styles.content}>
                        ...
                        <div className={styles.textarea}>
                            <textarea onChange={onMessageChange} value={props.state.newDialogMessage} ref={messageRef}/>
